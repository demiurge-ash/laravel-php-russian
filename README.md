...
+ [Использование хелперов для моделей](https://laravel.demiart.ru/laravel-model-helpers/)
+ [Уменьшаем сложность кода с помощью гвардов](https://laravel.demiart.ru/reducing-complexity-with-guards/)
+ [Делаем мидлвар с троттлингом](https://laravel.demiart.ru/custom-throttle-middleware/)
+ [DDD — новый хелпер для Laravel](https://laravel.demiart.ru/ddd-a-new-global-helper-for-laravel/)
+ [Мидлвар для ограничения очередей](https://laravel.demiart.ru/middleware-to-rate-limit-jobs/)
